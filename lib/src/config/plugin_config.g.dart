...
GsheetToArbConfig _$GsheetToArbConfigFromJson(Map<String, dynamic> json) {
  return GsheetToArbConfig(
    outputDirectoryPath: json['output_dir'] as String,
    arbDirectoryPath: json['arb_dir'] as String,
...
Map<String, dynamic> _$GsheetToArbConfigToJson(GsheetToArbConfig instance) =>
    <String, dynamic>{
      'output_dir': instance.outputDirectoryPath,
      'arb_dir': instance.arbDirectoryPath,
